...
user_login.send_keys("15851688868")
# 输入密码--通过html的id属性定位输入位置--改为你的密码
driver.find_element_by_id('user_password').send_keys("wjc000925")
...
driver.get('https://gitee.com/twzx/WuYi000925.github.io/pages')
...
fp = open("D:\hexo_deploy\log.txt", "a+")
